...
The _RMut_ package should be properly installed into the R environment by typing the following command into the R console:

_> install.packages("RMut")_

Though all of core algorithms written in Java, the _rJava_ package must be additionally installed in the R environment as well. 
